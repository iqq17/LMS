...
import { 
  ...
  Settings, Share2, Hand, Download, FileText, BookOpen, X 
} from "lucide-react"
      ...
      <div className="grid h-full lg:grid-cols-4">
        <div className="lg:col-span-3 p-4 space-y-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold gradient-text">Live Session</h1>
              <p className="text-muted-foreground">Tajweed Class</p>
            </div>
